...
export const mockRides: Ride[] = [
  ...
  },
  {
    ...
    from: "Coimbatore RS Puram",
    to: "TIDEL Park, Coimbatore",
    checkpoints: [
      { id: "c15", name: "RS Puram", lat: 11.0048, lng: 76.9547, arrivalTime: "07:45 AM" },
      { id: "c16", name: "Gandhipuram", lat: 11.0168, lng: 76.9558, arrivalTime: "08:00 AM" },
      { id: "c17", name: "Singanallur", lat: 11.0042, lng: 77.0065, arrivalTime: "08:20 AM" },
      { id: "c18", name: "Saravanampatti", lat: 11.0688, lng: 77.0096, arrivalTime: "08:45 AM" },
      { id: "c19", name: "TIDEL Park, Coimbatore", lat: 11.0741, lng: 77.0099, arrivalTime: "09:00 AM" },
    ],
  },
  {
    id: "5",
